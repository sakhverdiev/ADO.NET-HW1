    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    conStr.Open();
                    da = new SqlDataAdapter($"select * from Books", conStr);
                    dt = new DataTable();
                    da.Fill(dt);
                    dataGridViewBooks.DataSource = dt;

                    var queries = "Select Name From Categories; Select FirstName + LastName From Authors";
                    SqlCommand command = new SqlCommand(queries, conStr);
        ...
        private void Cb_Category_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    conStr.Open();
                    da = new SqlDataAdapter($"select Books.* from Books inner join Categories on Categories.Id = Books.Id_Category Where Categories.Name = '{cb_Category.SelectedItem.ToString()}'", conStr);
                    dt = new DataTable();
                    da.Fill(dt);
        ...
        private void Cb_Authors_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    conStr.Open();
                    da = new SqlDataAdapter($"select Books.* from Books inner join Authors on Books.Id_Author = Authors.Id Where Authors.FirstName + Authors.LastName = '{cb_Authors.SelectedItem.ToString()}'", conStr);
                    dt = new DataTable();
                    da.Fill(dt);
        ...
        private void Btn_Search_Click(object sender, EventArgs e)
        {
            if (txb_Search.Text != string.Empty)
            {
                try
                {
                    ...
                    {
                        conStr.Open();
                        da = new SqlDataAdapter($"select * from Books Where Name = '{txb_Search.Text}'", conStr);
                        dt = new DataTable();
                        da.Fill(dt);
        ...
        private void txb_Search_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    conStr.Open();
                    da = new SqlDataAdapter($"select * from Books Where Name Like '{txb_Search.Text}%'", conStr);
                    dt = new DataTable();
                    da.Fill(dt);
